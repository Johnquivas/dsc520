...
covid_df$date <- as.Date(x = covid_df$date)
...
ggplot(data=florida_df, aes(x=state, y=cases, group=1)) + geom_line()
...
### knitr::stitch("C:\\Users\\21428899\\OneDrive-Bellevue University\\Documents\\GitHub\\dsc520\\assignments\\assignment04\\assignment_04_Quintero_Vasquez_Johnatan.R")
